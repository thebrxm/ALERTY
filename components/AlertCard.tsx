    ...
    `}>
      ...
      <div className="flex-1 p-3 flex flex-col gap-1">
        ...
        <div className="mt-1">
          ...
          <div className="flex items-center gap-1.5 mt-1 text-slate-600 dark:text-slate-400">
            ...
            <p className="text-sm font-medium font-mono uppercase tracking-tight truncate max-w-[200px]">
              {alert.location}
            </p>
          </div>
      ...
      <div className="flex flex-col border-l border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
        <label className="flex-1 flex items-center justify-center px-3 cursor-pointer hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors group border-b border-slate-100 dark:border-slate-700">
          ...
          />
           <div className={`transition-all duration-200 ${isHandled ? 'text-emerald-600 dark:text-emerald-400 scale-110' : 'text-slate-300 dark:text-slate-600 group-hover:text-emerald-500 dark:group-hover:text-emerald-400'}`}>
        ...
        <a 
          ...
          className="flex-1 flex items-center justify-center px-3 text-slate-400 dark:text-slate-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors border-b border-slate-100 dark:border-slate-700"
          title="Ver Mapa"
        >
